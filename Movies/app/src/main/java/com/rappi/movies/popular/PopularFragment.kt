...
class PopularFragment : BaseFragment<PopularContract.Presenter>(),PopularContract.View {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        recycleGroup = root.findViewById(R.id.recyclePopularMovies)
        recycleGroup!!.layoutManager = GridLayoutManager(this@PopularFragment.context, 2)
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        searchPopularMovieButton.setOnClickListener {
            mPresenter.onSearchPressed(searchPopularMovie.text.toString())
        }
    }
